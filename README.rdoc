...
...using the following settings (for example):
  ...
  :gem_url: http://www.redalchemist.com
  :organization_name: Red Alchmist
  :organization_url: http://www.redalchemist.com 
...
If no options are configured, then the defaults are as follows:
  ...
  gem_url: "TODO: Add gem URL here."
  organization_name: <author name>
  organization_url: <author URL>
  year: <current year>
  ruby_version: 1.9.2
  rails_version: 3.1.1
